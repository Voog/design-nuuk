...
{% if article.data.article_settings.blog_layout == 0 or article.data.article_settings.blog_layout == 1 or article.data.article_settings.blog_layout == 2 %}
  {% assign blog_layout = article.data.article_settings.blog_layout %}
  {% assign article_data_blog_layout_defined = true %}
{% elsif site.data.article_settings.blog_layout == 2 %}
