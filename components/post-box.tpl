...
<article class="post_wrapper post {%- if _isArticle == true %} article_item {% else %} listing_item{%- endif -%}">
  ...
  <div class="post_content{% if _isArticle == true %} post_narrow{% endif %}">
    ...
    {% if _isArticle == true %}
      ...
      <div class="post_body content-formatted content-formatted--overflowed-images">{% content name="additional_body" bind="Article" title=bottom_content_title title_tooltip=bottom_content_title_tooltip %}</div>
    {% endif %}
